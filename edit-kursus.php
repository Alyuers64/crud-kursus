...
$id = $_GET["id"];
$rows = query("SELECT * FROM kursus WHERE id_kursus = '$id'")[0];
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edit Data Kursus</h4>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="judul" class="form-control"
                                            placeholder="Masukan Judul Kursus" value="<?= $rows["judul"] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="deskripsi" class="form-control"
                                            placeholder="Isi Deskripsi Kursus" value="<?= $rows["deskripsi"] ?>">
                                        </type=>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="time" name="durasi" class="form-control"
                                            placeholder="Isi Durasi Kursus" value="<?= $rows["durasi"] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-10">
